 ...
 */
final class Version20210421031243 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, domaines_id INT DEFAULT NULL, titre VARCHAR(50) NOT NULL, description VARCHAR(500) NOT NULL, niveau_etude NUMERIC(10, 0) DEFAULT NULL, nbr_annee_experience NUMERIC(10, 0) DEFAULT NULL, INDEX IDX_AF86866FA4AEAFEA (entreprise_id), INDEX IDX_AF86866F8783410C (domaines_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
